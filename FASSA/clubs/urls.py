...
urlpatterns = [
    ...
    path('clubs/<int:club_id>/members/', AdminClubMemberListCreateView.as_view(), name='admin-club-member-list-create'),
    path('clubs/members/<int:pk>/', AdminClubMemberRetrieveUpdateDeleteView.as_view(), name='admin-club-member-detail'),
